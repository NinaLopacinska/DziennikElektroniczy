...
import com.projekt.dzienniczek.ui.ocenyNauczyciel.KlasyAdapter
import com.projekt.dzienniczek.ui.ocenyNauczyciel.PrzedmiotyAdapter
    ...
    override fun onCreateView(
        ...
        viewModel.userSubjectAndSchooldataLiveData.observe(viewLifecycleOwner) { (subject, schooldata) ->
            if (subject != null && schooldata != null) {
                ...
                val adapterKlasy = KlasyAdapter(activity as MainActivity, schooldata.toMutableList())
                ...
                binding.buttonSend.setOnClickListener {
                    if (selectedDate != null
                        && binding.inputOpis.text.isNotEmpty()
                        && (binding.spinnerClass.selectedItem as SchoolClass).id_klasa != null
